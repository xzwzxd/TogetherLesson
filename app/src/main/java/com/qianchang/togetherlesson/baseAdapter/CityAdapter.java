...
import com.qianchang.togetherlesson.bean.AreaBean;
...
public class CityAdapter extends RecyclerView.Adapter<CityAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int position) {
        viewHolder.tv_city.setText(list.get(position).title+"("+list.get(position).num+")");
        if (position == selection) {
            viewHolder.tv_city.setTextColor(context.getResources().getColor(R.color.pop_select));
