package com.qianchang.togetherlesson.pull;
...
public class RotateLoadingLayout extends LoadingLayout {
    ...
    private ProgressBar pull_to_refresh_header_progressbar;
    /**旋转的动画*/
   // private Animation mRotateAnimation;
    ...
    private void init(Context context) {
       ...
       // mArrowImageView = (ImageView) findViewById(R.id.pull_to_refresh_header_arrow);
        ...
        pull_to_refresh_header_progressbar=(ProgressBar) findViewById(R.id.pull_to_refresh_header_progressbar);
        pull_to_refresh_header_progressbar.setVisibility(VISIBLE);
